---
layout: post
title:  "052_Zigbee通信实验_网络控制蜂鸣器实验"
date:   2023-05-22 10:18:00 +0800
categories: getting started
---

# Zigbee通信实验_网络控制蜂鸣器实验
<!-- ------------------------ -->
## 实验内容
...
[LED模块](https://docs.stepiot.com/docs/aiot002)
...
① 将LED模块和蜂鸣器模块安装在CC2530底座上，CC Debugger连接电脑与协调器节点的底座，如下图所示：

![模块组装](/assets/Zigbee/61.jpg)
...
⑥ 打开 `IAR Embedded Workbench` 工程软件，点击工具栏： `File` -> `Open` -> `Workspace`，选择工程文件：`ZigBee通信实验\9.ZigBee网络控制蜂鸣器实验\Projects\zstack\Samples\SampleApp\CC2530DB\SampleApp.eww` 并打开。
   
![打开工程](/assets/CC2530/6.jpg)
    
![选择文件](/assets/Zigbee/62.jpg)  
...
![退出仿真](/assets/Zigbee/63.jpg) 

⑰ 按下协调器的的按键S1，控制终端节点蜂鸣器响起/停止。
...
`Coordinator.c` ->`SampleApp_ProcessEvent()`函数是任务处理函数，在其中检测按键S1是否按下，按键S1按键下，发送蜂鸣器控制指令。
