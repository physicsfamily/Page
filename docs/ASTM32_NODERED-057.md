---
layout: post
title:  "057_STM32组合实验_NODERED平台显示人体红外实验"
...
⑰ NODERED平台显示实验数据。(脚本位于：`基于STM32 NODERED实验\5.NODERED平台显示人体红外实验\人体感应.json`)。具体操作参考[node red](https://codelabs.stepiot.com/docs/ASTM32_NodeRED-082.html)平台应用手册。
