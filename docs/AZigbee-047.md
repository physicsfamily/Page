...
① 将OLED模块、PM2.5模块分别安装CC2530底座上，CC Debugger连接电脑与协调器节点的底座，如下图所示：
...
`SampleApp_MessageMSGCB()`函数中，如果接收到的消息ID为`PM2P5_CLUSTERID`，是PM2.5数据，并显示数据。
