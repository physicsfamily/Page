---
layout: post
title:  "060_STM32组合实验_OneNET平台控制风扇实验"
date:   2023-05-22 10:18:00 +0800
categories: getting started
---

# STM32组合实验_OneNET平台控制风扇实验
<!-- ------------------------ -->
## 实验内容
...
⑪ 将STLink连接到风扇节点，点击工具栏： ` Project` -> `Open Project`，选择工程文件：`基于STM32 OneNET实验\8.OneNET平台控制风扇实验\风扇模块程序\USER\Fan.uvprojx` 并打开。
...
⑰ OneNET平台控制。(脚本位于：`基于STM32 OneNET实验\8.OneNET平台控制风扇实验\WiFi连接OneNET脚本文件\wifisample.lua`)。具体操作参考[OneNET](https://codelab.stepiot.com/codelabs/oneNet_080/index.html?index=..%2F..index#0)平台应用手册。

![OneNET平台操作](/assets/STM32_OneNET/56.jpg)
...
1. 在OneNET平台增加一个按键控制风扇中速转运(能观察到转速比全速转动慢即可)。
