...
⑰ NODERED平台显示实验数据。(脚本位于：`基于STM32 NODERED实验\4.NODERED平台显示超PM2.5实验\PM25数据显示.json`)。具体操作参考[node red](https://codelabs.stepiot.com/docs/ASTM32_NodeRED-082.html)平台应用手册。
