...
[超声波模块](https://docs.stepiot.com/docs/aiot006) & 超声波探头
...
① 将OLED模块、超声波模块分别安装CC2530底座上，CC Debugger连接电脑与协调器节点的底座，如下图所示：
...
SampleApp_MessageMSGCB()函数中，如果接收到的消息ID为DISTANCE_CLUSTERID,就是光电开关的检测数据，并显示检测数据。
