---
layout: post
title:  "069_CC2530_OneNET平台控制风扇实验"
date:   2023-05-22 10:18:00 +0800
categories: getting started
---

# CC2530_OneNET平台控制风扇实验
<!-- ------------------------ -->
## 实验内容
Duration: 2
...
⑥ 打开 `IAR Embedded Workbench` 工程软件，点击工具栏： `File` -> `Open` -> `Workspace`，选择工程文件：`基于CC2530 OneNET实验\8.OneNET平台控制风扇实验\Projects\zstack\Samples\SampleApp\CC2530DB\SampleApp.eww` 并打开。
...
![设置按键开关值](assets/STM32_OneNET/55.png)
...
![OneNET平台显示](assets/CC2530_OneNET/56.png) 
